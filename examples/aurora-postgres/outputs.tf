...
output "cluster_arn" {
  ...
  value       = module.aurora-postgresql.cluster_arn
}

output "cluster_id" {
  description = "The RDS Cluster Identifier"
  value       = module.aurora-postgresql.cluster_id
}

output "cluster_resource_id" {
  description = "The RDS Cluster Resource ID"
  value       = module.aurora-postgresql.cluster_resource_id
}

output "cluster_members" {
  description = "List of RDS Instances that are a part of this cluster"
  value       = module.aurora-postgresql.cluster_members
}

output "cluster_endpoint" {
  description = "Writer endpoint for the cluster"
  value       = module.aurora-postgresql.cluster_endpoint
}

output "cluster_reader_endpoint" {
  description = "A read-only endpoint for the cluster, automatically load-balanced across replicas"
  value       = module.aurora-postgresql.cluster_reader_endpoint
}

output "cluster_master_user_secret" {
  value = module.aurora-postgresql.cluster_master_user_secret[0].secret_arn
}
...
output "proxy_id" {
  ...
  value       = module.aurora-postgresql.proxy_id
}

output "proxy_arn" {
  description = "The Amazon Resource Name (ARN) for the proxy"
  value       = module.aurora-postgresql.proxy_arn
}
...
output "proxy_target_id" {
  ...
  value       = module.aurora-postgresql.proxy_target_id
}

output "proxy_target_port" {
  description = "Port for the target RDS DB Instance or aurora-postgresql DB Cluster"
  value       = module.aurora-postgresql.proxy_target_port
}

output "proxy_name" {
  description = "Identifier representing the DB Instance or DB Cluster target"
  value       = module.aurora-postgresql.proxy_name
}
...
output "proxy_target_target_arn" {
  ...
  value       = module.aurora-postgresql.proxy_target_target_arn
}
